...
Using the validated architecture from Step 2, for each module create `docs/design/{module-name}/design.md` containing:
...
For each module, create `docs/design/{module-name}/tests.md` containing:
...
Create `docs/design/architecture.md` containing:
